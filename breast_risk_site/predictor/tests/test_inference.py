...
from predictor.services.inference import run_image_model, run_factors_model, ensemble
...
def test_risk_model_prob_in_range():
    rf = RiskFactors(age=50, first_degree_relative=1, onset_age_relative=45,
                     brca1=0, brca2=1, menarche_age=12, menopause_age=None,
                     parity=2, hrt=1, bmi=28.5, alcohol_units_per_week=4.0,
                     smoking_status=0, activity_hours_per_week=3.0)
